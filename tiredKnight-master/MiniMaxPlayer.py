    ...
    def move(self, board: chess.Board) -> chess.Move:
        ...
        for move in legal_moves:
            ...
            if board.can_claim_draw():
                ...
                temp = minimizer(board, self.max_depth, self.alfa, self.beta, self.evaluate) if self.player_color else maximizer(board, self.max_depth, self.alfa, self.beta, self.evaluate)
            if self.player_color:
                if temp >= value:
                    value = temp
                    best_move = move
